    ...
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => ['role.list.update', $role->id], 'method' =>'POST']) !!}
                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach ($dataPermission as $pms)
                                    <div class="col-md-3">
                                        {!! Form::checkbox('permission_id[]', $pms->id, in_array($pms->id, $role->permissions->pluck('id')->toArray()), [
                                            'class' => 'permission',
                                            'id' => $pms->slug,
                                        ]) !!}
                ...
                @endforeach
                {!! Form::submit('Cập nhật', ['name' => 'btn-update', 'class' => 'btn btn-primary']) !!}
                {!! Form::close() !!}
            </div>
        </div>
    </div>
