        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('product.cat.addStore') }}" method="POST">
                            @csrf
                            ...
                            <button type="submit" name="btn_add_product" value="Thêm danh mục" class="btn btn-primary">Thêm
                                mới</button>
                        </form>
                    </div>
                </div>
                                ...
                                @if (!empty($cats_data_level))
                                    ...
                                    @foreach ($cats_data_level as $k => $e)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('product.cat.edit', $e['cat_id']) }}"
                                                ...
                                                @if (
                                                    ...
                                                    <a href="{{ route('product.cat.delete', $e['cat_id']) }}"
