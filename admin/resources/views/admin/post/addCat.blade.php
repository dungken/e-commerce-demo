        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('post.cat.addStore') }}" method="POST">
                            @csrf
                            ...
                            <button type="submit" name="btn_add_cat" value="Thêm danh mục" class="btn btn-primary">Thêm
                                mới</button>
                        </form>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (
                                                    ...
                                                    <a href="{{ route('post.cat.delete', $e['cat_id']) }}"
